...
import com.example.rashmitiwari.we_sync.model.DrawingView;
import com.example.rashmitiwari.we_sync.R;


public class SketchPad extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eraseBtn.setOnClickListener(SketchPad.this);
            ...
            saveDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener(){
                public void onClick(DialogInterface dialog, int which){
                    ...
                    String imgSaved = MediaStore.Images.Media.insertImage(
                            SketchPad.this.getContentResolver(), drawView.getDrawingCache(),
